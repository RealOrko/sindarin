...
long sum_lengths(char * *);

long count_words(char * text) {
    RtArena *__arena_1__ = rt_arena_create(NULL);
    long _return_value = 0;
    char * * words = rt_str_split(__arena_1__, text, " ");
    long count = rt_array_length(words);
    _return_value = count;
    goto count_words_return;
count_words_return:
    rt_arena_destroy(__arena_1__);
    return _return_value;
}

long sum_lengths(char * * items) {
    RtArena *__arena_1__ = rt_arena_create(NULL);
    long _return_value = 0;
    long total = 0L;
    {
        char * * __arr_0__ = items;
        ...
        for (long __idx_0__ = 0; __idx_0__ < __len_0__; __idx_0__++) {
            ...
            char * item = __arr_0__[__idx_0__];
            {
                (total = rt_add_long(total, rt_str_length(item)));
            }
        __loop_cleanup_0__:
...
int main() {
    RtArena *__arena_1__ = rt_arena_create(NULL);
    int _return_value = 0;
    char * text = rt_to_string_string(__arena_1__, "hello world from sindarin");
    long word_count = count_words(text);
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2;
        _str_part0 = rt_to_string_string(__arena_1__, "Word count: ");
        _str_part1 = rt_to_string_long(__arena_1__, word_count);
    ...
    char * * strings = rt_array_create_string(__arena_1__, 3, (char *[]){"apple", "banana", "cherry"});
    long total_len = sum_lengths(strings);
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2;
        _str_part0 = rt_to_string_string(__arena_1__, "Total length: ");
        _str_part1 = rt_to_string_long(__arena_1__, total_len);
        _str_part2 = rt_to_string_string(__arena_1__, "\n");
        char *_concat_tmp0;
        _concat_tmp0 = rt_str_concat(__arena_1__, _str_part0, _str_part1);
        char *_interpol_result = rt_str_concat(__arena_1__, _concat_tmp0, _str_part2);
