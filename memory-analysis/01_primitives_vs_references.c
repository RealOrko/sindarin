...
int main() {
    ...
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2, *_str_part3, *_str_part4;
        _str_part0 = rt_to_string_string(__arena_1__, "a = ");
        _str_part1 = rt_to_string_long(__arena_1__, a);
        _str_part2 = rt_to_string_string(__arena_1__, ", b = ");
        _str_part3 = rt_to_string_long(__arena_1__, b);
        _str_part4 = rt_to_string_string(__arena_1__, "\n");
        char *_concat_tmp0;
        char *_concat_tmp1;
        char *_concat_tmp2;
        _concat_tmp0 = rt_str_concat(__arena_1__, _str_part0, _str_part1);
        _concat_tmp1 = rt_str_concat(__arena_1__, _concat_tmp0, _str_part2);
        _concat_tmp2 = rt_str_concat(__arena_1__, _concat_tmp1, _str_part3);
        char *_interpol_result = rt_str_concat(__arena_1__, _concat_tmp2, _str_part4);
        _interpol_result;
    });
        rt_print_string(_str_arg0);
    });
    long * x = rt_array_create_long(__arena_1__, 3, (long[]){1L, 2L, 3L});
    long * y = x;
    (y = rt_array_push_long(__arena_1__, y, 4L));
    rt_print_string("x = ");
    rt_print_array_long(x);
    rt_print_string("\n");
    rt_print_string("y = ");
    rt_print_array_long(y);
    rt_print_string("\n");
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2, *_str_part3, *_str_part4;
        _str_part0 = rt_to_string_string(__arena_1__, "x.length = ");
        _str_part1 = rt_to_string_long(__arena_1__, rt_array_length(x));
        _str_part2 = rt_to_string_string(__arena_1__, ", y.length = ");
        _str_part3 = rt_to_string_long(__arena_1__, rt_array_length(y));
        _str_part4 = rt_to_string_string(__arena_1__, "\n");
        char *_concat_tmp0;
        char *_concat_tmp1;
        char *_concat_tmp2;
