...
int main() {
    ...
    int _return_value = 0;
    long * original = rt_array_create_long(__arena_1__, 3, (long[]){1L, 2L, 3L});
    rt_print_string("Original: ");
    rt_print_array_long(original);
    rt_print_string("\n");
    long * copy1 = rt_array_clone_long(__arena_1__, original);
    (copy1 = rt_array_push_long(__arena_1__, copy1, 100L));
    rt_print_string("After copy1.push(100):\n");
    rt_print_string("  original = ");
    rt_print_array_long(original);
    rt_print_string("\n");
    rt_print_string("  copy1 = ");
    rt_print_array_long(copy1);
    rt_print_string("\n");
    long * copy2 = rt_array_clone_long(__arena_1__, original);
    (copy2 = rt_array_push_long(__arena_1__, copy2, 200L));
    rt_print_string("After copy2.push(200):\n");
    rt_print_string("  original = ");
    rt_print_array_long(original);
    rt_print_string("\n");
    rt_print_string("  copy2 = ");
    rt_print_array_long(copy2);
    rt_print_string("\n");
    goto main_return;
main_return:
