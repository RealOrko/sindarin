...
int main() {
    ...
    long char_count = 0L;
    {
        ...
        char * * data = rt_array_create_string(__arena_2__, 3, (char *[]){"line one", "line two", "line three"});
        char * text = rt_to_string_string(__arena_2__, "some temporary text");
        (line_count = rt_array_length(data));
        {
            char * * __arr_0__ = data;
            long __len_0__ = rt_array_length(__arr_0__);
            for (long __idx_0__ = 0; __idx_0__ < __len_0__; __idx_0__++) {
                RtArena *__loop_arena_0__ = rt_arena_create(__arena_2__);
                char * line = __arr_0__[__idx_0__];
                {
                    (char_count = rt_add_long(char_count, rt_str_length(line)));
                }
            __loop_cleanup_0__:
    ...
    ({
        ...
        _str_part0 = rt_to_string_string(__arena_1__, "Line count: ");
        _str_part1 = rt_to_string_long(__arena_1__, line_count);
    ...
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2;
        _str_part0 = rt_to_string_string(__arena_1__, "Total characters: ");
        _str_part1 = rt_to_string_long(__arena_1__, char_count);
        _str_part2 = rt_to_string_string(__arena_1__, "\n");
        char *_concat_tmp0;
        _concat_tmp0 = rt_str_concat(__arena_1__, _str_part0, _str_part1);
        char *_interpol_result = rt_str_concat(__arena_1__, _concat_tmp0, _str_part2);
    ...
    rt_print_string("Private block memory freed - no leaks possible\n");
    goto main_return;
main_return:
