...
int main() {
    ...
    int _return_value = 0;
    long stack_val = 42L;
    long stack_copy = stack_val;
    (stack_copy = 100L);
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2, *_str_part3, *_str_part4;
        _str_part0 = rt_to_string_string(__arena_1__, "stack_val = ");
        _str_part1 = rt_to_string_long(__arena_1__, stack_val);
        _str_part2 = rt_to_string_string(__arena_1__, ", stack_copy = ");
        _str_part3 = rt_to_string_long(__arena_1__, stack_copy);
    ...
    long *heap_val = (long *)rt_arena_alloc(__arena_1__, sizeof(long));
    *heap_val = 42L;
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2;
        _str_part0 = rt_to_string_string(__arena_1__, "heap_val = ");
        _str_part1 = rt_to_string_long(__arena_1__, (*heap_val));
    ...
    ({
        char *_str_arg0 = ({
        char *_str_part0, *_str_part1, *_str_part2;
        _str_part0 = rt_to_string_string(__arena_1__, "heap_val after modification = ");
        _str_part1 = rt_to_string_long(__arena_1__, (*heap_val));
        _str_part2 = rt_to_string_string(__arena_1__, "\n");
        char *_concat_tmp0;
        _concat_tmp0 = rt_str_concat(__arena_1__, _str_part0, _str_part1);
