...
int main() {
    ...
    int _return_value = 0;
    char * * items = rt_array_create_string(__arena_1__, 3, (char *[]){"apple", "banana", "cherry"});
    {
        ...
        for (long __idx_0__ = 0; __idx_0__ < __len_0__; __idx_0__++) {
            ...
            {
                char * upper = rt_str_toUpper(__loop_arena_0__, item);
                char * msg = rt_str_concat(__loop_arena_0__, "Processing: ", upper);
                rt_print_string(msg);
                rt_print_string("\n");
            }
        __loop_cleanup_0__:
    ...
    rt_print_string("Loop complete - all temporaries cleaned up\n");
    goto main_return;
main_return:
