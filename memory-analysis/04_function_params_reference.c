...
void modify_array(long * arr) {
    ...
    (arr = rt_array_push_long(__arena_1__, arr, 100L));
    (arr = rt_array_push_long(__arena_1__, arr, 200L));
    rt_print_string("Inside function, arr = ");
...
int main() {
    ...
    rt_print_string("Before function call: ");
    rt_print_array_long(nums);
    rt_print_string("\n");
    modify_array(nums);
    rt_print_string("After function call: ");
    rt_print_array_long(nums);
    rt_print_string("\n");
    rt_print_string("(Array was passed by reference - caller sees modifications)\n");
    goto main_return;
main_return:
    rt_arena_destroy(__arena_1__);
