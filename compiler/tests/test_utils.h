...
static const char *CODE_GEN_RUNTIME_HEADER =
    ...
    "extern long *rt_array_slice_long(long *, long, long, long);\n"
    "extern double *rt_array_slice_double(double *, long, long, long);\n"
    "extern char *rt_array_slice_char(char *, long, long, long);\n"
    "extern int *rt_array_slice_bool(int *, long, long, long);\n"
    "extern char **rt_array_slice_string(char **, long, long, long);\n\n"
    "/* Runtime array reverse functions */\n"
    "extern long *rt_array_rev_long(long *);\n"
    "extern double *rt_array_rev_double(double *);\n"
    "extern char *rt_array_rev_char(char *);\n"
    "extern int *rt_array_rev_bool(int *);\n"
    "extern char **rt_array_rev_string(char **);\n\n"
    "/* Runtime array remove functions */\n"
    "extern long *rt_array_rem_long(long *, long);\n"
    "extern double *rt_array_rem_double(double *, long);\n"
    "extern char *rt_array_rem_char(char *, long);\n"
    "extern int *rt_array_rem_bool(int *, long);\n"
    "extern char **rt_array_rem_string(char **, long);\n\n"
    "/* Runtime array insert functions */\n"
    "extern long *rt_array_ins_long(long *, long, long);\n"
    "extern double *rt_array_ins_double(double *, double, long);\n"
    "extern char *rt_array_ins_char(char *, char, long);\n"
    "extern int *rt_array_ins_bool(int *, int, long);\n"
    "extern char **rt_array_ins_string(char **, const char *, long);\n\n"
    "/* Runtime array push (copy) functions */\n"
    "extern long *rt_array_push_copy_long(long *, long);\n"
    "extern double *rt_array_push_copy_double(double *, double);\n"
    "extern char *rt_array_push_copy_char(char *, char);\n"
    "extern int *rt_array_push_copy_bool(int *, int);\n"
    "extern char **rt_array_push_copy_string(char **, const char *);\n\n"
    ...
    "extern long *rt_array_clone_long(long *);\n"
    "extern double *rt_array_clone_double(double *);\n"
    "extern char *rt_array_clone_char(char *);\n"
    "extern int *rt_array_clone_bool(int *);\n"
    "extern char **rt_array_clone_string(char **);\n\n"
    "/* Runtime array join functions */\n"
    "extern char *rt_array_join_long(long *, const char *);\n"
    "extern char *rt_array_join_double(double *, const char *);\n"
    "extern char *rt_array_join_char(char *, const char *);\n"
    "extern char *rt_array_join_bool(int *, const char *);\n"
    "extern char *rt_array_join_string(char **, const char *);\n\n"
    "/* Runtime array create from static data */\n"
    "extern long *rt_array_create_long(size_t, const long *);\n"
    "extern double *rt_array_create_double(size_t, const double *);\n"
    "extern char *rt_array_create_char(size_t, const char *);\n"
    "extern int *rt_array_create_bool(size_t, const int *);\n"
    "extern char **rt_array_create_string(size_t, const char **);\n\n"
