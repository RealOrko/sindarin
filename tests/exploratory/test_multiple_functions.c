...
long long double_val(long long);
long long triple_val(long long);
...
long long double_val(long long x) {
    long long _return_value = 0;
    _return_value = rt_mul_long(x, 2LL);
    goto double_val_return;
double_val_return:
    return _return_value;
}

long long triple_val(long long x) {
    long long _return_value = 0;
    _return_value = rt_mul_long(x, 3LL);
    goto triple_val_return;
triple_val_return:
    return _return_value;
}
...
long long process(long long x) {
    ...
    if (__rt_interceptor_count > 0) {
        RtAny __args[1];
        __args[0] = rt_box_int(x);
        __rt_thunk_args = __args;
        RtAny __intercepted = rt_call_intercepted("double_val", __args, 1, __thunk_0);
        __intercept_result = rt_unbox_int(__intercepted);
    } else {
        __intercept_result = double_val(x);
    }
    __intercept_result;
});
    long long t = ({
    ...
    if (__rt_interceptor_count > 0) {
        ...
        __args[0] = rt_box_int(x);
        __rt_thunk_args = __args;
        RtAny __intercepted = rt_call_intercepted("triple_val", __args, 1, __thunk_1);
        __intercept_result = rt_unbox_int(__intercepted);
    } else {
        __intercept_result = triple_val(x);
    }
    __intercept_result;
});
    _return_value = rt_add_long(d, t);
    goto process_return;
process_return:
    return _return_value;
}
...
int main() {
    ...
    if (__rt_interceptor_count > 0) {
        ...
        RtAny __intercepted = rt_call_intercepted("process", __args, 1, __thunk_2);
        __intercept_result = rt_unbox_int(__intercepted);
    } else {
        __intercept_result = process(10LL);
    }
    __intercept_result;
});
    ({
...
static RtAny __thunk_0(void) {
    RtAny __result = rt_box_int(double_val(rt_unbox_int(__rt_thunk_args[0])));
    return __result;
}

static RtAny __thunk_1(void) {
    RtAny __result = rt_box_int(triple_val(rt_unbox_int(__rt_thunk_args[0])));
    return __result;
}

static RtAny __thunk_2(void) {
    RtAny __result = rt_box_int(process(rt_unbox_int(__rt_thunk_args[0])));
    return __result;
}
