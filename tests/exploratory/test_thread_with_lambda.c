...
long long times_two(RtArena *, long long);
long long apply_operation(RtArena *, long long, __Closure__ *);
...
static void *__thread_wrapper_0__(void *args_ptr) {
    ...
    if (__rt_interceptor_count > 0) {
        ...
        __args[1] = rt_box_function(args->arg1);
        __rt_thunk_args = __args;
        __rt_thunk_arena = __arena__;
        RtAny __intercepted = rt_call_intercepted("apply_operation", __args, 2, __thread_thunk_0);
        __result__ = rt_unbox_int(__intercepted);
    } else {
        __result__ = apply_operation(__arena__, args->arg0, args->arg1);
    }
    ...
    rt_thread_result_set_value(args->result, &__result__, sizeof(long long), __result_arena__);
...
static long long __fn_thunk_1__(void *__cl__, long long __p0__);

long long times_two(RtArena *__caller_arena__, long long x) {
    RtArena *__local_arena__ = rt_arena_create(__caller_arena__);
    long long _return_value = 0;
    _return_value = rt_mul_long(x, 2LL);
    goto times_two_return;
times_two_return:
    rt_arena_destroy(__local_arena__);
    return _return_value;
}

long long apply_operation(RtArena *__caller_arena__, long long x, __Closure__ * op) {
    RtArena *__local_arena__ = rt_arena_create(__caller_arena__);
    long long _return_value = 0;
    _return_value = ((long long (*)(void *, long long))op->fn)(op, x);
    goto apply_operation_return;
apply_operation_return:
    rt_arena_destroy(__local_arena__);
    return _return_value;
}
...
int main() {
    ...
    int _return_value = 0;
    rt_print_string("Testing threads with function operations\n");
    RtThreadHandle *__result_pending__ = ({
    ...
    __spawn_args_0__->arg0 = 21LL; __spawn_args_0__->arg1 = ({ __Closure__ *__fn_cl__ = rt_arena_alloc(__local_arena__, sizeof(__Closure__)); __fn_cl__->fn = (void *)__fn_thunk_1__; __fn_cl__->arena = __local_arena__; __fn_cl__; }); 
    /* Spawn the thread */
    RtThreadHandle *__spawn_handle_0__ = rt_thread_spawn(__local_arena__, __thread_wrapper_0__, __spawn_args_0__);
    __spawn_handle_0__->result_type = RT_TYPE_INT;
    __spawn_handle_0__;
});
    long long result;
    result = *(long long *)rt_thread_sync_with_result(__result_pending__, __local_arena__, RT_TYPE_INT);
    ({
        char *_str_arg0 = ({
        char *_p0 = rt_to_string_long(__local_arena__, result);
    ...
    if (rt_eq_long(result, 42LL)) {
        {
            rt_print_string("SUCCESS: Thread with function parameter works\n");
        }
    }
    else {
        {
        ...
        char *_str_arg0 = ({
        char *_p0 = rt_to_string_long(__local_arena__, result);
        char *_r = rt_str_concat(__local_arena__, "FAILURE: Expected 42, got ", _p0);
        _r = rt_str_concat(__local_arena__, _r, "\n");
        _r;
    });
        rt_print_string(_str_arg0);
...
static long long __fn_thunk_1__(void *__cl__, long long __p0__) { (void)__cl__; return times_two(__p0__); }

/* Interceptor thunk definitions */
static RtAny __thread_thunk_0(void) {
    RtAny __result = rt_box_int(apply_operation((RtArena *)__rt_thunk_arena, rt_unbox_int(__rt_thunk_args[0]), rt_unbox_function(__rt_thunk_args[1])));
    return __result;
}
