...
void test_code_gen_array_type_in_function_param()
{
    ...
    param.type = arr_type;
    param.mem_qualifier = MEM_DEFAULT;
    ...
    *body = NULL;
    ...
    // Note: With MEM_DEFAULT qualifier and empty body, no arena is needed
    // Array parameters are only cloned with MEM_AS_VAL qualifier
    const char *expected = get_expected(&arena,
                                  "void print_arr(long *);\n\n"
